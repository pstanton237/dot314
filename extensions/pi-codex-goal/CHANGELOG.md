...
- Start proactive mid-run compaction at the next provider-context boundary after a qualifying tool turn, ensuring the complete tool call and results are persisted before compaction mutates session context.
