...
export interface GoalRuntimeInputContextHandlerContext extends StaleQueuedWorkEffectContext {
  runtimeState: Pick<
    GoalRuntimeState,
    "currentTurnIndex" | "proactiveCompactionPhase" | "staleQueuedWorkGuard"
  >;
  stateController: Pick<
    GoalStateController,
    "getGoal" | "isCurrentActiveGoalId" | "pauseForAbort" | "persistHostOverflowUserReset"
  >;
...
export interface GoalRuntimeTurnHandlerContext extends StaleQueuedWorkEffectContext {
  runtimeState: Pick<
    GoalRuntimeState,
    "currentTurnIndex" | "proactiveCompactionPhase" | "recoveryState" | "staleQueuedWorkGuard"
  >;
  stateController: Pick<
    GoalStateController,
...
export interface GoalRuntimeAgentHandlerContext extends StaleQueuedWorkEffectContext {
  runtimeState: Pick<
    GoalRuntimeState,
    "agentRunSequence" | "proactiveCompactionPhase" | "staleQueuedWorkGuard"
  >;
